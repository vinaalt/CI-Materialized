            ...
            <div id="table-datatables">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m8 l11">
                        <a href="<?php echo base_url(); ?>barang/export" class="btn cyan waves-effect waves-light">
                            Excel <i class="mdi-action-print right"></i>
                        </a>
                        <a class="btn waves-effect waves-light indigo" href="<?= base_url(); ?>barang/exportPDF">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>barang/ubah/<?= $barang->idBarang ?>" rel="tooltip" title="Ubah" style="color:purple">
                                                <i class="mdi-editor-bordercolor"></i>
                                            </a> &nbsp;
                                        </td>
                                    </tr>
                                <?php } ?>
